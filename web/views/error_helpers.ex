defmodule LoudBackend.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LoudBackend.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LoudBackend.Gettext, "errors", msg, opts)
    end
  end
